  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-sky-400 text-primary-foreground hove:bg-sky-400/90 border-sky-500 border-b-4 active:border-b-0",
        ...
        ghost:"bg-transparent text-slate-500 boreder-transparent border-0 hover:bg-slate-100",
        sidebar:"bg-transparent text-slate-500 boreder-transparent border-2 hover:bg-slate-100 transition-none",
